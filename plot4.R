...
with(electric_1_2,{
    plot(electric_1_2$Time,as.numeric(as.character(electric_1_2$Global_active_power)),type="l",  xlab="",ylab="Global Active Power")  
    plot(electric_1_2$Time,as.numeric(as.character(electric_1_2$Voltage)), type="l",xlab="datetime",ylab="Voltage")
    plot(electric_1_2$Time,electric_1_2$Sub_metering_1,type="n",xlab="",ylab="Energy sub metering")
    ...
    plot(electric_1_2$Time,as.numeric(as.character(electric_1_2$Global_reactive_power)),type="l",xlab="datetime",ylab="Global_reactive_power")
})
